 ...
 */
public class MorphyMappingToCsv {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        if (args.length != 1) {
            System.out.println("Usage: " + MorphyMappingToCsv.class.getSimpleName() + " <morphyExportFile>");
            System.exit(1);
        }
        final MorphyMappingToCsv prg = new MorphyMappingToCsv();
